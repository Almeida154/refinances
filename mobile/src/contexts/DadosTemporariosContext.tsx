...
import { Lancamento } from './LancamentosContext';
import { Categoria } from './CategoriesContext';
import { Conta } from './ContasContext';
...
const DadosTempContext = createContext<DadosTempContextType>({} as DadosTempContextType);

export const UseDadosTemp = () => useContext(DadosTempContext);

export const DadosTempProvider: React.FC = ({ children }) => {
    const [categoriasTemp, setCategoriasTemp] = useState<Categoria[]>([{}] as Categoria[]);
